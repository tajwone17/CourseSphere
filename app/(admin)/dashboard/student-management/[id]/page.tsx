...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    const grossTuition =
      totalCredits * (parseFloat(financials.feePerCredit) || 0);
    const discountedTuition =
      grossTuition * (1 - (parseFloat(financials.waiver) || 0) / 100);
  ...
  useEffect(() => {
    const total =
      ...
      (parseFloat(financials.libraryFee) || 0) +
    ...
    <div className="mx-auto max-w-7xl p-8">
        ...
        <>
          ...
          <div className="mb-8">
            ...
            <div className="rounded-lg bg-gray-900 p-10">
              lorerm ipsum dolor sit amet, consectetur adipiscing elit. Integer
        ...
        <div className="mb-10 rounded-lg border border-gray-700 bg-gray-800 p-6">
          ...
          <div className="mt-6 text-white">
            ...
            <p className="mt-2 text-xl font-bold">
              Total Payable: {totalPayable.toFixed(2)} BDT
            </p>
          </div>
        </div>
      )}
      ...
      <div className="mt-8 flex flex-wrap items-center justify-between">
        <Link href="/dashboard/student-management">
          <Button
            className="mb-5 flex items-center gap-2 bg-white text-black hover:bg-gray-300"
