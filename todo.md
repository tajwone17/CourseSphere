...
- Implement student management page where approved/pending will be listed. The request will come from registration page.(for advisor)
  -role-exam controller->add/edit update results(also keep in mind about retake)
  url~http://localhost:3000/dashboard/manage-results
...
-problems->siging out when refreshing
